...
export const CONTENT_DEFS: ContentDef[] = [
  ...
  { key: "join.step2.cta_url", page: "Join Us", label: "Step 2 interest form URL", fallback: "https://forms.gle/2YyjdjmrMPQz8UrB8" },
  ...
  { key: "join.step3.cta_url", page: "Join Us", label: "Step 3 GroupMe URL", fallback: "https://groupme.com/join_group/116786870/3sLL3IHw" },
